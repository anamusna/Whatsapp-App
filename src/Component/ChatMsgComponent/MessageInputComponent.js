...
import ChatInput from './ChatInput.scss';

class ChatMsgComponent extends Component {

  render() {
    return (
      <div className={ ChatInput.ChatInputHolder }>

          <div className={ ChatInput.emojiContainer }>
            ...
            <div className={ ChatInput.inputContainer }>
              <input
                type ="text"
